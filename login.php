                ...
                <div class="login-section-right">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <h2 class="login-sb-title text-center text-lg-start text-md-center">Login</h2>
                                <p class="login-para text-center text-lg-start text-md-center">Login to your User dashboard</p>
                            </div>
